                ...
                <i class="fa fa-angle-double-down"></i>
                                ...
                                <tr class="hideableRow hiddenRow">
                                 ...
                                 <td colspan="6" align="right">
                                    ...
                                    <td style="display:none;" class="text-right" colspan="6"><b><?php echo display('change') ?>:</b></td>
                                    <td style="display:none;" class="text-right">
                                        <input style="display:none;" type="text" id="change" class="form-control text-right" name="change" value="0" readonly="readonly"/>
                                    </td>
                                </tr>
                                </tfoot>
                            </table>
