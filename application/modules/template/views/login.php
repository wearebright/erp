...
<html lang="en">
    ...
    <body>
        <!-- Content Wrapper -->
        <div class="bg-placeholder" data-large="<?php echo base_url('assets/img/bms-bg-2.jpg') ?>">
            <img src="<?php echo base_url('assets/img/bms-bg-2-sm.jpg') ?>" class="bg-small">
   ...
   <div class="panel panel-bd">
        ...
        <div class="panel-body">
            ...
            <div class="form-group">
                ...
                <br>
                <span><a href="#"  data-toggle="modal" data-target="#passwordrecoverymodal"><b class="text-right"><?php echo display('forgot_password')?></b></a></span>
            </div>
            ...
            <div>
                <button class="btn btn-success btn-block">Login to BMS</button>
            </div>
            <?php echo form_close() ?>
        </div>
...
<div class="modal fade" id="passwordrecoverymodal" tabindex="-1" role="dialog" aria-labelledby="recoverylabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    var placeholder = document.querySelector('.bg-placeholder'),
        small = placeholder.querySelector('.bg-small')
    ...
    imgLarge.onload = function () {
        ...
        // small.classList.remove('bg-small');
    };
