    ...
    <?php }?>
            ...
            ?>">
             ...
             <?php if($this->permission1->method('purchase_report_category_wise','read')->access()){ ?>
                    ...
                    <li class="treeview <?php if ($this->uri->segment('1') == ("return_to_sender_report")){
                        echo "active";
                    } else {
                        echo " ";
                    }?>">
