        ...
        <?php if($this->permission1->method('orders_tracker','read')->access()){?>
            <li class="treeview <?= $this->uri->segment(1)=="orders_tracker" ?"active":null ?>">
                ...
                <ul class="treeview-menu">
                    <?php 
                        if($this->permission1->method('orders_tracker','read')->access()){ 
                    ?>
                        <li  class="treeview <?= $this->uri->segment('1') == ("order_tracker") ? "active": ""?>" >
                            <a href="<?php echo base_url('orders') ?>"><?php echo display('order_tracker') ?></a></li>
                        </li>
                    <?php
                        }
                    ?>
      ...
      <!-- Stock menu start -->
        ...
        ?>">
            ...
            <ul class="treeview-menu">
                ...
                <?php 
                    if($this->permission1->method('edit_stocks','read')->access()){ 
                ?>
                    <li  class="treeview <?= $this->uri->segment('1') == ("edit_stocks") ? "active": ""?>">
                        <a href="<?php echo base_url('edit_stocks') ?>"><?php echo display('edit_stocks') ?></a></li>
                    </li>
                <?php
                    }
                ?>
