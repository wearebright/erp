            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body"> 
                        <?php echo form_open('top_returning_product', array('class' => 'form-inline', 'method' => 'get')) ?>
                            ...
                            <div class="col-sm-8">
                            <input type="text" autocomplete="off" autocomplete="off" name="from_date" class="form-control datepicker" id="from_date" placeholder="<?php echo display('start_date') ?>" value="<?php echo $from?>">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="col-sm-8">
                            <input type="text" autocomplete="off" autocomplete="off" name="to_date" class="form-control datepicker" id="to_date" placeholder="<?php echo display('end_date') ?>" value="<?php echo $to?>">
                        </div>  
                        </div>
                            </div>
                            <div class="col-sm-2">
                            ...
                            <span><?php echo display('sales_report_product_wise') ?></span>
                             <span class="padding-lefttitle">
                                ...
                                <?php if($this->permission1->method('top_returning_product','read')->access()){ ?>
                                    <a href="<?php echo base_url('top_returning_product') ?>" class="btn btn-primary m-b-5 m-r-2"><i class="ti-align-justify"> </i>  <?php echo display('top_returning_product') ?> </a>
                                <?php }?>
