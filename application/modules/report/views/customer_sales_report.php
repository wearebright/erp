            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body"> 
                        <?php echo form_open('customer_sales_report', array('class' => 'form-inline', 'method' => 'get')) ?>
                        
                            <div class="col-sm-3">
                           
                            <label class="col-sm-4" for="user_name"><?php echo display('customer') ?></label>
                            <div class="col-sm-8">
                           <select name="customer_id" class="form-control">
                               <option value=""> Select Cusomer</option>
                               <?php foreach($customer_list as $customer){?>
                               <option value="<?php echo $customer['customer_id']?>" <?php if($customer_id == $customer['customer_id']){echo 'selected';}?>><?php echo $customer['customer_name']?></option>
                               <?php }?>
                           </select>
                       </div>
                            </div>
                ...
                <div class="panel panel-bd lobidrag">
                    <div class="panel-heading">
                        <div class="panel-title">
                            <span><?php echo display('customer_sales_history') ?> </span>
                    ...
                    <div class="panel-body">
                        <div id="purchase_div">
                            ...
                            <div class="table-responsive paddin5ps">
                                ...
                                <tr>
                                    <td><?php echo $sl;?></td>
                                    <td><?php echo html_escape($sales['customer_name'])?></td>
                                    <td>
