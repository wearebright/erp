            ...
            <div class="col-sm-12">
                <div class="panel panel-default">
                    <div class="panel-body"> 
                        <?php echo form_open('rts_reasons', array('class' => 'form-inline', 'method' => 'get')) ?>
                            ...
                            <span><?php echo display('sales_report_product_wise') ?></span>
                             <span class="padding-lefttitle">
                                ...
                                <?php if($this->permission1->method('rts_reasons','read')->access()){ ?>
                                    <a href="<?php echo base_url('rts_reasons') ?>" class="btn btn-primary m-b-5 m-r-2"><i class="ti-align-justify"> </i>  <?php echo display('rts_reasons') ?> </a>
                                <?php }?>         
                             </span>
                        </div>
                    </div>
